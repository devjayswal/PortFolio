...
export const metadata = {
  ...
  description: "I am a software developer with 2+ years of experience in full-stack, AI/ML, and cloud computing.",
  keywords: [
    "Dev Jayswal",
    "software developer",
    "portfolio",
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark !scroll-smooth">
      <body
        className={`${spaceMono.className} bg-gray-50 text-gray-950 relative pt-28 sm:pt-36 dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-90`}
      >
