...
export const experiencesData = [
  {
      ...
      location: "Remote",
      description: "Working as a freelance developer, building robust solutions for various clients. Developed a custom CRM system to streamline business processes and 'Eazy-Tutors', build Mits-Sats, for automating the scheduling and management of  classes, tutors, classrooms and mutliple branches handled more than 100 branch able to schedule np hard problem with 2 second response time.",
...
export const projectsData = [
  ...
  {
      title: "SchedulAI",
      description: "Source code of a scheduler which is created for automate the process of time table creation. This utilize PPO RL technique for scheduling.",
